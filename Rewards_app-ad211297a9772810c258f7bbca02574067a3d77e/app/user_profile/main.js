      ...
      <Text style={styles.sectionTitle}>(Favorite Sport) Updates</Text>
        <View style={styles.updateCard}>
          ...
          <View style={styles.gameInfo}>
            <Text style={styles.gameTitle}>Jaspers vs Fordham</Text>
            <Pressable style={styles.viewButton} onPress={handleViewGame}>
        ...
        <View style={styles.updateCard}>
          ...
          />
          <View style={styles.gameInfo}>
            <Text style={styles.gameTitle}>Jaspers vs St. John's</Text>
            <Pressable style={styles.viewButton} onPress={handleViewGame}>
              <Text style={styles.viewButtonText}>View</Text>
            </Pressable>
          </View>
        ...
        <View style={styles.updateCard}>
          ...
          />
          <View style={styles.gameInfo}>
            <Text style={styles.gameTitle}>Jaspers vs Iona</Text>
            <Pressable style={styles.viewButton} onPress={handleViewGame}>
              <Text style={styles.viewButtonText}>View</Text>
            </Pressable>
          </View>
